...
import { getEmployeeAllOrders } from '../../../services/admin/adminservice';
const EmployeeOrders = () => {
  ...
  const _getAllOrders = useCallback(async () => {
    try {
      const response = await getEmployeeAllOrders(id);
                          ...
                          <div className="w-24 text-center">
                            <p
                              className={`text-sm font-semibold border rounded-lg p-1 ${
                                e?.cartDataObj?.order_status === 'Order Placed'
                                  ? 'border-orange-500 text-orange-500 bg-white'
                                  : e?.cartDataObj?.order_status === 'Delivered'
