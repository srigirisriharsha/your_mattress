...
const AdminBuyNowStages = ({
  ...
  const steps = [
    ...
    { label: 'Customer Details', icon: <FaUser size={24} /> },
    { label: 'Place Order', icon: <FaCheckCircle size={24} /> },
...
export default AdminBuyNowStages;
